  ...
  return(
      ...
      <HeroSlider {...setting}>
        {
          image.map((image,index)=>(
            <div className='w-full h-56 md:h-80 py-3 cursor-pointer'  key={index}>
              <img src={`https://image.tmdb.org/t/p/original${image.backdrop_path}`} alt="animated movie" className='w-full h-full rounded-md object-cover'/>
            </div>
          ))
        }
      </HeroSlider>
    ...
    <div className='hidden lg:block'>
      <HeroSlider {...settingLg}>
        {
          image.map((image,index)=>(
            <div className='w-full h-96 px-2 py-3 cursor-pointer' key={index}>
              <img src={`https://image.tmdb.org/t/p/original${image.backdrop_path}`} alt="animated movie" className='w-full h-full rounded-md object-cover'/>
            </div>
          ))
        }
